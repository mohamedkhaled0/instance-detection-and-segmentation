function   [final_result,p_lung,p_chest]=sup_classifier(M4)
  
%  Estimating the density of lung and chest tissues.
%  Estimating the prior probability of lung and chest tissues.
%  Using the model to classify the remained image. 
